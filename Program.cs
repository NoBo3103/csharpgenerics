...
namespace GenericsAssignment1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nAfter removing Garlic from the list the total products are:");
            Products.Remove("garlic");
            printAllProducts(Products);
            PrintTotalProducts(Products);
            Console.WriteLine("\n");

            //If the user adds 50 cabbages to the inventory, 
            //       print the final quantity of cabbage in the inventory.

            System.Console.WriteLine($"\n\nAfter adding 50 more cabbages, the total quantity of Cabbages is {  AddQuantity(Products, "cabbage", 50)}.");
            Console.WriteLine("\n");
